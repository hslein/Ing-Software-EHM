...
const missionVision = {
  image: 'https://imagenes.portafolio.co/files/og_thumbnail/uploads/2021/10/01/6157aa86b6c1c.jpeg',
  mission: 'Nuestra misión es proporcionar a nuestros clientes la mejor experiencia en la compra de vehículos, ofreciendo asesoría personalizada, una amplia gama de opciones y un servicio excepcional que supere sus expectativas.',
  vision: 'Ser el concesionario líder en Colombia, reconocido por nuestra innovación, calidad de servicio y compromiso con la satisfacción del cliente, contribuyendo al desarrollo sostenible del sector automotriz.'
};
</script>
...
<template>
  ...
  <section v-if="!showBrandVehicles" class="mission-vision-section">
    <div class="mission-vision-container">
      <div class="mission-vision-image">
        <img :src="missionVision.image" alt="Nuestra empresa" />
      </div>
...
.mission-vision-image img {
  ...
  object-fit: cover;
  border-radius: 12px;
  box-shadow: 0 10px 30px rgba(42, 53, 89, 0.15);
}
...
.mission, .vision {
  ...
  padding: 2rem;
  border-radius: 12px;
  box-shadow: 0 8px 25px rgba(42, 53, 89, 0.1);
  border: 1px solid #e7ebff;
}
